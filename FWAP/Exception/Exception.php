...
class Exception {
  ...
  <code>$<en>MY_PROJECT_NAME = 'MINHA APLICACÃO';</code><br/><br/> ");
    ...
    public static function notHeader() {
        ...
        Auth::Auth("<br/>Não foi criado o arquivo <code>header.phtml</code> na pasta View ");
    }

    public static function notFooter() {

        Auth::Auth("<br/>Não foi criado o arquivo <code>footer.phtml</code> na pasta view");
    }

    public static function notIndex($viewPath) {

        Auth::Auth("<br/>Não foi criado o arquivo <code>index.phtml</code> no <code>directório $viewPath em View</code>");
    }

    public static function notFound() {

        require_once 'FWAP/Exception/404.php';
    }
